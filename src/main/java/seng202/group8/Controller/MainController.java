...
public class MainController implements Initializable {
    ...
    @FXML
    public AddAirportViewController addAirportViewController;
    @FXML
    ...
    */
    ...
    public void getRouteSourceDestination (List sorted){
        addRouteViewController.setRouteSourceDestination(sorted);
    }
